...
export default function Navbar(){
  ...
  ">
    ...
    ">
      {
        status === "unauthenticated" && <Link href="/login" className="text-lg font-semibold flex items-center gap-2">
      ...
      {status === "authenticated" &&
        <>
          <Link href={`/@${session.user.username}`} className="flex items-center gap-2 group p-2">
            ...
            <span className="hidden text-lg group-hover:underline group-hover:opacity-60 transition-opacity md:inline">
